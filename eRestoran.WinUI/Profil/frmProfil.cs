...
namespace eRestoran.WinUI.Profil
{
    public partial class frmProfil : Form
    {
        ...
        public frmProfil(int? ZaposlenikID = null)
        {
                InitializeComponent();
                _id = Global.LoggedUser.ZaposlenikId;

                DialogResult = DialogResult.None;
        }

        private async void frmProfileDetalji_Load(object sender, EventArgs e)
        {
        ...
        {
            if (txtIme.Text.Length == 0 || txtPrezime.Text.Length == 0 || txtTelefon.Text.Length == 0 || txtEmail.Text.Length==0 || KorisnickoIme.Text.Length==0 ||
                Lozinka.Text.Length==0 || textLozinkaPotvrda.Text.Length==0)
            {
